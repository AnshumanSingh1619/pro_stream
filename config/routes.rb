...
Rails.application.routes.draw do
  ...
  post '/movies', to: 'index#showmovie', as: 'show_movie'
  post '/webseries', to: 'index#showwebseries', as: 'show_webseries'
  post 'categorised/:search_term2/:column_name', to: 'index#categorised', as: 'custom_content'
  ...
  post '/mylist',  to: 'my_lists#index', as: 'mylists' 
