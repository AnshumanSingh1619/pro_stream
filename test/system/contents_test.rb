...
class ContentsTest < ApplicationSystemTestCase
  ...
  test "should create content" do
    ...
    fill_in "Actor", with: @content.actor
    check "Available for kids" if @content.available_for_kids
    fill_in "Description", with: @content.description
    fill_in "Director", with: @content.director
    fill_in "Language", with: @content.language
    fill_in "Movie type", with: @content.movie_type
    fill_in "Name", with: @content.name
    fill_in "Type of content", with: @content.type_of_content
